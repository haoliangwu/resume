...
Project.setGitHub('https://github.com/haoliangwu')
    ...
    return (
      <Grid width={1} className='projects'>
        <Grid width={1} className='project-wrapper'>
          <Project name='vscode-poshi-extension' date='2016.4-至今' _role='全栈开发' href='/vscode-poshi'>
          ...
          <Project name='react-ui' date='2015.10-至今' _role='项目参与者' href='/react-ui'>
            <p className='description'>github上的开源项目，由于项目的owner是大神，而且比较忙，对于编写测试用例分身乏术，我帮他维护一部分测试用例以确保项目更好地发展，主要包含单元测试和e2e测试。</p>
            <p className='description'>利用工作之余的时间，从零开始，为这个项目搭建自动化测试框架的过程中，使我收获颇多，尤其是编写对于web应用UI组件相关的测试用例，同时也提高了使用react框架的熟练度。</p>
          </Project>
          <Project name='teatray-screenshot' date='2016.4-2016-5' _role='全栈开发' href='/testray-screenshot'>
          ...
          <Project name='fixpack-workbench' date='2015.11-2016.3' _role='全栈开发' href='/FixPack-Workbench'>
          ...
          <Project name='easy-comment' date='2015.8-2015-10' _role='全栈开发' href='/EasyComment'>
